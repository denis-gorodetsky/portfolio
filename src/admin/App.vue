      ...
      .container
        .header__wrapper
          .header__logo
            ...
            .header__block
              .header__name
                h1.header__name-title Денис Городецкий
              .header__text-box
                .header__typepanel
        ...
        .container
                  ...
                  .form__wrapper
                    .form__row
                      label(data-text="Название").form__elem
                        .form__elem-container
                          input(type="text" placeholder="Дизайн сайта").form__elem-input
                    .form__row
                      label(data-text="Ссылка").form__elem
                        .form__elem-container
                          input(type="text" placeholder="https://site.ru").form__elem-input
                    .form__row.form__row--textarea
                      label(data-text="Описание").form__elem
                        .form__elem-container
                          textarea(type="textarea" placeholder="Сайт.ру").form__elem-textarea
          ...
          -
            ...
            [
              {
                "id": 1,
                "title": "Лендинг шоколадок Chocco",
                "skills": "HTML, Sass, JQuery, YandexAPI, FlexBox",
                "photo": "slider-image3.jpg",
                "link": "//google.ru",
                "desc": "Сайт адаптивен. Технологии: OnePageScroll, Api-медиа (работа с видео), Yandex-Maps и форма обратной связи"
              },
              {
                "id": 2,
                "title": "Сайт компании Afrodita",
                "skills": "HTML, CSS",
